...
attributes: "cooperative skills, proactive, adaptive management and organisational skills, public speaking and communication, cheerful $\\Summertree$"
...
skillset: 
  ...
  - {cat: "Reproducibility", name: "I create reports using RMarkdown, markdown, Sweave, RShiny, and LaTeX. I collaborate and perform version control using Git."}
  - {cat: "Front-End and Back-End", name: "I am comfortable with using UNIX/Linux shell, and have limited experience with HTML and CSS."}
...
mentoring:
  - {year: "2016-2017",
     student: "Wayne Toh",
     what: "Peer-mentoring under the Biology Graduate-Undergraduate Mentorship Program",
     where: "Concordia University"}
  - {year: "2013", 
